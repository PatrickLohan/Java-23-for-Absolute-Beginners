...
public class WeakDictionary {
    private static final Logger LOGGER = LoggerFactory.getLogger(WeakDictionary.class);
    ...
    private Map<Integer, String> initDictionary() {
        ...
        IntStream.range(0, 100_000).forEach(i -> dict.put(i, valGen.genName()));
        LOGGER.info("Done creating dictionary: {}", System.currentTimeMillis());
        cleaner.register(dict, ()-> LOGGER.info("Cleaned up the dictionary!"));
        return dict;
    }
}
